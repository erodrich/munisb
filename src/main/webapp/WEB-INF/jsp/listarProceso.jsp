<%-- 
    ...
    Created on : 05/04/2018, 12:44:36 PM
    Author     : Eric
--%>
...
<html>
    <head>
        ...
        <title>Listar Evaluar Proceso</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <h2>Listar Requerimientos Procesados</h2>
            <p>
                <form:form action="buscarProcesoReq.htm" method="POST" modelAttribute="busquedareq">
        ...
        <table class="table table-striped" style="font-size: smaller; padding-left: 10px; padding-right: 10px;">
            ...
            <c:forEach var="epip" items="${list}">
                <tr style="text-align: center;">
                    <td><a href="${pageContext.request.contextPath}/detalleProcesoReq/${epip.codigo}.htm">${epip.identificador}</a></td>
                    <td>${epip.nombre}</td>
                    <td>${epip.tipo}</td>
